...
def points_to_density_img(vertices, width, height):
    xy_density, scale_3d_2d, mins_3d, bev_normals = get_density(vertices, width, height)
...
def get_density(points, width=512, height=512):
    ...
    return density, scale_3d_2d, mins, None
...
def read_laz(laz_path):
    ...
    with laspy.open(str(laz_path)) as input_las:
        ...
        input_las.header.point_format.dimension_names
